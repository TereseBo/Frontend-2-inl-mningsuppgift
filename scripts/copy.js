...
$(document).ready(function () {//TODO: Add all steps to create the gallery
    ...
    //$("main").append('<img class=cardimage</img>')
...
function createCardFromArrOgObj(arrObj) {//Creates cards for every object in an array of objects
    ...
    arrObj.forEach(item => {
        ...
        $(`#card${n}`).append(`<img class='card${n}-img' src="../../images/${showPic}" alt="${altText}" ></img>`);//Create an image for the card and add it to the card
